...
| **`test_plot_quality_distribution.py`** | Confirms that the distribution bar chart PNG is saved cor rectly and that missing or invalid column names are handled appropriately. |
